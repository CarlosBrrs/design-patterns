...
/**
 * Data Access Object Pattern or DAO pattern is used to separate low level data accessing API or operations from high
 * level business services. Following are the participants in Data Access Object Pattern.
 *
...
public class DaoPatternDemo {
    public static void main(String[] args) {
        ...
        //print all students
        studentDao.getAllStudents().forEach(student -> System.out.println("Student: [RollNo : " + student.getRollNo() + ", Name : " + student.getName() + " ]"));
